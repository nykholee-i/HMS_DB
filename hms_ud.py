...
def show_appointment_summary(appointment_info):
    def update_appointment():
        ...
        def save_updated_appointment():
            ...
            update_query = "UPDATE appointments SET patient_name=%s, age=%s, contact_number=%s, sex=%s, reason=%s, disease=%s, doctor=%s, appointment_time=%s, appointment_date=%s, amount=%s WHERE IdNo=%s"
