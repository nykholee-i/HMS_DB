...
password_entry = None
username_entry = None
appointment_frame = None  # Add this line to define appointment_frame
#############################################################################################################################
...
####################################################################### idk paano mahide yung scheduling tas summary lang lalabas
    root.withdraw()
...
def search_appointments():
    ...
    results = []
    for appointment in appointment.values():
        if (not search_date or appointment["Appointment Date"] == search_date) and \
           (not search_time or appointment["Slot"] == search_time) and \
           (not search_doctor or appointment["Doctor"] == search_doctor):
